...
После съёмки: колода отдаёт 79 слайдов, все 43 PNG подставляются вместо заглушек, сломанных изображений и ошибок JavaScript нет. Прямые ссылки по исходным номерам и по всем дополнительным (`#24a` … `#78c`) работают, как и переходы из содержания и увеличение кадра.
