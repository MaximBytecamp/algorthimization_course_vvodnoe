...
# Слайд 179. Только учебные данные
...
Шаг 5. Data validation для status
...
Шаг 9. Extensions → Apps Script

## Текст

В нашей Google Sheet откройте:
...
Шаг 14. Не записывать одну заявку дважды
...
Создаём timestamp непосредственно в Apps Script:
...
Шаг 16. Новая заявка всегда new
...
Если UTM нет, используем понятные значения:
...
Теперь пустой источник не превращается в непонятное пустое поле.
...
В окне Deployment нажмите выбор типа.
...
Шаг 22. Deployment configuration
...
```text
GA4 Leads Receiver v1
```

Для учебного стенда Web App должен выполняться с правами владельца скрипта и принимать обращения от пользователей формы.
...
Шаг 23. Разрешить Apps Script работать с таблицей
...
Шаг 25. Открыть проект в VS Code
...
Шаг 29. Добавить технические поля
...
Шаг 31. Передать источник в форму
...
Шаг 32. Открыть тестовую ссылку
...
Шаг 33. Уникальный ID в браузере
...
Шаг 34. generate_lead никуда не исчезает
...
Шаг 35. JavaScript перед отправкой
...
Шаг 37. Зафиксировать изменение
...
Шаг 43. Попробовать отправить пустую форму
...
Шаг 44. Смоделировать duplicate ID
...
Шаг 45. Ввести неверное состояние
...
Шаг 46. Заявка начинает обрабатываться
...
Наш Apps Script — учебный приёмник.
...
почему учебный Apps Script endpoint не является полноценным production backend.
...
Шаг 8а. Выделить столбец для второго правила
