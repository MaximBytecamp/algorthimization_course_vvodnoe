(() => {
  ...
  const staggerSelector = [
    ...
    '.ruler .seg', '.tally__row', '.dict tbody tr', '.hunt > li',
    '.rulebook > div', '.derive__r', '.ex > div', '.reds > div',
    '.steps > li', '.accept li', '.hw li', '.gap3 > div'
  ].join(',');
  ...
  function updateUi() {
    ...
    document.title = `${pad(index + 1)} · Занятие 2 · UTM-метки`;
