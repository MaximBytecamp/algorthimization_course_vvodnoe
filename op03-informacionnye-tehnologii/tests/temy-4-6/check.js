/* ---------------------------------------------------------------
   ...
   теста 1 по воронке и UTM, — преподавателю не нужно помнить новый.
...
async function verify(code) {
  ...
  if (parts.length !== 3 || parts[0] !== QUIZ.prefix) return { fatal: `Это не код результата теста по темам 4, 5, 6 (ожидается ${QUIZ.prefix}.…).` };
