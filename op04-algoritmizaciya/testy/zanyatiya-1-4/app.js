/* Тест ОП.04 по занятиям 1, 3, 4. Одна попытка, 20 минут, разбор после отправки.

   Состояние живёт в localStorage этого браузера:
     op04-test-z134:state  — идёт попытка (ФИО, порядок, ответы, дедлайн, уходы)
     op04-test-z134:result — попытка завершена, оценка и ответы зафиксированы
