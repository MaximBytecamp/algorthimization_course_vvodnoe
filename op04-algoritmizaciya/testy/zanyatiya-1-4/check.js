/* ---------------------------------------------------------------
   ...
   тестов ОП.03 и ДУП.02, — преподавателю не нужно помнить новый.
...
async function verify(code) {
  ...
  if (parts.length !== 3 || parts[0] !== QUIZ.prefix) return { fatal: `Это не код результата теста по занятиям 1, 3, 4 (ожидается ${QUIZ.prefix}.…).` };
