/* ---------------------------------------------------------------
   ...
   тестов ОП.03, ДУП.02 и ОП.04, — преподавателю не нужно помнить новый.
...
async function verify(code) {
  ...
  if (parts.length !== 3 || parts[0] !== QUIZ.prefix) return { fatal: `Это не код результата теста по теме 02 (ожидается ${QUIZ.prefix}.…).` };
