...
const lessonGroups = [
  { title: 'Что стандартизируем', slug: 'chto-standartiziruem', color: '#2d6fd0', bridge: 'Начинаем с того, что именно будем стандартизировать и чем стандартизация отличается от проверки.', time: 'часть 1', start: 1, end: 3 },
  { title: 'Запрос, ответ, ресурс', slug: 'zapros-otvet-resurs', color: '#2a72c4', bridge: 'Правила пишутся для обмена сообщениями между программами, поэтому сначала разберём один такой обмен.', time: 'часть 2', start: 4, end: 8 },
  { title: 'Архитектурный стиль REST', slug: 'rest', color: '#2575b8', bridge: 'Ресурс, метод и код ответа пришли в HTTP API из архитектурного стиля REST. Разберём его ограничения.', time: 'часть 3', start: 9, end: 15 },
  { title: 'Правила HTTP API', slug: 'pravila-http-api', color: '#1f7aa6', bridge: 'REST задаёт принципы, но не говорит, как назвать адрес и какой код вернуть. Это решают правила HTTP API.', time: 'часть 4', start: 16, end: 33 },
  { title: 'Практика: контракт', slug: 'praktika-kontrakt', color: '#1a7d93', bridge: 'Правил уже достаточно, чтобы спроектировать контракт Service Desk и найти ошибки в чужом.', time: 'часть 5', start: 34, end: 36 },
  { title: 'OpenAPI', slug: 'openapi', color: '#177f80', bridge: 'Контракт спроектирован. Теперь его нужно записать так, чтобы документ не разошёлся с кодом.', time: 'часть 6', start: 37, end: 53 },
  { title: 'FastAPI и документация', slug: 'fastapi-dokumentaciya', color: '#1a7f6b', bridge: 'Документ OpenAPI можно писать руками, а можно получать из кода. Учебный проект делает второе.', time: 'часть 7', start: 54, end: 60 },
  { title: 'Единый формат ошибок', slug: 'oshibki', color: '#2b7d57', bridge: 'Успешные ответы описаны схемами. Ошибкам нужен такой же единый формат на весь API.', time: 'часть 8', start: 61, end: 65 },
  { title: 'Версии и изменения', slug: 'versii', color: '#4a7a45', bridge: 'Контракт вместе с ошибками готов. Следующий вопрос — как его менять, не ломая клиентов.', time: 'часть 9', start: 66, end: 75 },
  { title: 'Стандарт и его проверка', slug: 'standart-i-proverka', color: '#6d7340', bridge: 'Правила именования, ошибок и версий уже есть. Их нужно собрать в один стандарт и проверять автоматически.', time: 'часть 10', start: 76, end: 86 },
  { title: 'Стандарты реальных команд', slug: 'standarty-kompaniy', color: '#8a6a3d', bridge: 'Так устроен стандарт учебного проекта. Посмотрим, как это делают OpenAPI Initiative, Zalando, Microsoft и другие.', time: 'часть 11', start: 87, end: 94 },
  { title: 'Репозиторий API на GitHub', slug: 'repozitoriy-api', color: '#97583f', bridge: 'Компании публикуют не только описание API, но и правила работы с его репозиторием.', time: 'часть 12', start: 95, end: 103 },
  { title: 'Заголовки и совместимость', slug: 'zagolovki-sovmestimost', color: '#8f4550', bridge: 'Репозиторий оформлен. Остались правила, которые клиент видит в каждом ответе: заголовки версии, лимитов и совместимости.', time: 'часть 13', start: 104, end: 113 },
  { title: 'Практическая работа', slug: 'prakticheskaya-rabota', color: '#7a3a5d', bridge: 'Все механизмы собраны в учебном эталоне. Его структура становится образцом для вашей работы.', time: 'часть 14', start: 114, end: 120 },
  { title: 'Итог темы', slug: 'itog', color: '#5c3159', bridge: 'Практическая работа закрывает тему. Соберём весь процесс в одну схему.', time: 'часть 15', start: 121, end: 122 },
];
...
const lessonSlides = [
  ...
  // 112
  {
    ...
    body: split(
      table(['Что сравниваем', 'Учебный стенд', 'Production'], [
