...
Все снимки сделаны на учебном стенде справочника через Playwright (headless Chromium).
...
медиана, p95 и этапы в главе 1.7 — из таблиц того же кейса, то есть учебные;
схемы в главах 1.2 и 1.3 показывают порядок величин и отношения, а не измерения.

## Измерения и учебные данные
...
Учебные, а не измеренные данные: ряды CPU в главе 1.2, числа кейса в главе 1.7,
